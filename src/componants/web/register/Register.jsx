...
export default function Register() {
  ...
  return (
    <>
    <div className='container w-50 m-auto pt-2  mt-3 '>
        <h2 className='pt-4'> Create Acount  </h2> 
        <form className='pt-3 ' onSubmit={formik.handleSubmit} encType='multipart/form-data'>
            {renderInputs}
            <button disabled={!formik.isValid} type='submit' className='text-black bg-warning pt-2 pb-2 pe-4 ps-4  rounded-pill  border-0 mb-3'> Register </button>
        </form>
